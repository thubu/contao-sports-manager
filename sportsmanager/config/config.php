 ...
 */
 $GLOBALS['BE_MOD']['spoma data'] = array
 (
 /**	'tl_spoma_stadium' => array
	(
		'tables' => array('tl_spoma_stadium','tl_spoma_teams_to_stadium'),
		'icon'   => 'system/modules/sportsmanager/assets/images/club.png'
	 ), */
	 'tl_spoma_clubs' => array
	 (
	    'tables' => array('tl_spoma_clubs','tl_spoma_teams_to_club'),
		'icon'   => 'system/modules/sportsmanager/assets/images/club.png'
	 ),
	 'tl_spoma_teams' => array
	 (
	    'tables' => array('tl_spoma_teams'),
		'icon'   => 'system/modules/sportsmanager/assets/images/teams.png'
	 ),
	 'tl_spoma_players' => array
	 (
